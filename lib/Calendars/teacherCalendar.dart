...
class _TeacherCalendarState extends State<TeacherCalendar> {
  ...
  Future<void> _loadTeacherSchool() async {
    ...
    if (!teacherDoc.exists) {
      debugPrint('Teacher document does not exist');
      return;
    }
    ...
    setState(() {
      ...
      teacherSchoolId =
      teacherDoc.data()!.containsKey('schoolId')
          ? teacherDoc['schoolId']
          : teacherDoc['schoolIds']; // fallback for old data
    });

    if (teacherSchoolId != null && teacherSchoolId!.isNotEmpty) {
      _listenToEvents();
    }
  }

  void _listenToEvents() {
    if (teacherSchoolId == null || teacherSchoolId!.isEmpty) return;
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              actions: [
                ElevatedButton(
                  onPressed: () async {
                    if (_eventController.text.isEmpty || teacherSchoolId == null)
                      return;
